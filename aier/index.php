...
<section id="home-page" class="animate-box" data-animate-effect="fadeInUp">
        ...
        <h2>Welcome to <br> Adishesha Institute of Education & Researc</h2>
...
<div class="about-us-main">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <p class="animate-box" data-animate-effect="fadeInUp">
                Our mission is to provide exceptional educational experiences that equip students with the knowledge, skills, and character necessary to succeed in an ever-evolving world. We strive to make a positive impact on learners' lives, enabling them to become empathetic, responsible global citizens and future leaders.
            </p>
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <p class="animate-box" data-animate-effect="fadeInUp">
                ...
                <ul class="animate-box" data-animate-effect="fadeInUp">
                    ...
                    <li><b>Cutting-Edge Technology: </b>We leverage the latest educational technologies to enhance the learning experience, incorporating interactive elements that make learning fun and engaging.</li>
                    <li><b>Holistic Development: </b>Beyond academics, we focus on the overall development of our students. Our programs nurture creativity, critical thinking, and character building, preparing them for success in all areas of life.</li>
                </ul>
            </p>
