...
<main style="height: 150vh;">
        ...
        <div class="home-about-us-content">
            ...
            <div class="row">
                <div class="col-md-6 animate-box" data-animate-effect="fadeInUp">
                    <img src="assets/images/web/about1.png" style="width: 90%;">
                </div>
                <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-4 animate-box" data-animate-effect="fadeInUp">
                <div class="service-container-box">
                    ...
                    <a href="#">You still need to make sure to attract those who click on the page. You can achieve this by having insightful, exciting content and ultimately makes them believe that they really need what you are offering.</a>
                </div>
            </div>
            <div class="col-md-4 animate-box" data-animate-effect="fadeInUp">
                <div class="service-container-box">
                    <i class="fa-solid fa-brain"></i>
                    <h3>Memory Booster</h3>
                    <a href="#">You still need to make sure to attract those who click on the page. You can achieve this by having insightful, exciting content and ultimately makes them believe that they really need what you are offering.</a>
                </div>
            </div>
            <div class="col-md-4 animate-box" data-animate-effect="fadeInUp">
    ...
    <section class="testimonial" id="testimonial-page">
